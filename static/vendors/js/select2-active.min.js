...
function storageformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"> <img src="/static/images/storage-icons/' +
      $(e).data("storage") +
...
function userformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"> <img src="/static/images/avatar/' +
      $(e).data("user") +
      '.png" class="avatar-image avatar-sm" /> ' +
      t.text +
      "</span>",
...
function paymentformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"> <img src="/static/images/payment/' +
      $(e).data("payment") +
...
function flagformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"> <img src="/static/vendors/img/flags/1x1/' +
      $(e).data("flag") +
      '.svg" class="avatar-image avatar-sm" /> ' +
      t.text +
      "</span>",
...
function stateformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"> <img src="/static/vendors/img/flags/us/' +
      $(e).data("state") +
      '.png" class="avatar-image avatar-sm" /> ' +
      t.text +
      "</span>",
